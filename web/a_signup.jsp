...
function validate_form()							 
{
	...
	var p2=document.getElementById("pwd-repeat");
	...
	else if(!/^[a-zA-Z]*$/g.test(fn.value)) 
	{
...
body {font-family: Times New Roman, Georgia, sans-serif;}
...
@media screen and (max-width: 300px) {
    ...
    body{
     background-image: url('C:\Users\mohan\Downloads\logo.png');
...
<div class="container">
    <form name="RegForm" action="store_data1" class="form-inline" onsubmit="return validate_form()" method="post" >
    
    
      <h1> SIGN UP FOR APPLICANTS</h1>
      <b>Fill in this form to create an account.</b>
      <hr>
	
	<label for="fname"><b>First Name</b><span style="color:red;">*</span></label>
	<input type="text" placeholder="Enter Name" name="fname" onKeyPress="return ValidateAlpha(event);" required>
        <br>
        <br>
        Date of Birth:<input type="date" name="dob" value=""
               min="1968-10-11" max="1998-10-11" required/>
        <br>
        <br>

        <label for="email-ID"><b>Email</b>&nbsp;&nbsp;&nbsp;</label><span style="color:red;">*</span>
	<input type="email" placeholder="Enter Email" name="email" required>
	<br>
	<br>
        <label for="pwd"><b>Password      </b><span style="color:red;">*</span></label>
	<input type="password" placeholder="Enter Password" name="pwd" id="pwd" required>
	<br>
        <label for="pwd-repeat"><b>Re-type Password</b><span style="color:red;">*</span></label>
     	 <input type="password" placeholder="Re-type Password" name="pwd-repeat" id="pwd-repeat" required>
      	<br>
    	<div class="clearfix">

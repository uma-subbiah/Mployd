   ...
   border-bottom: 1px solid #333; /* some styling */
    ...
    <body style="background-image: url('http://designtowwebberz.com/images/slider/development.jpg')">
      ...
      String c=null;
       ...
       String q="SELECT * from Personal_details WHERE Applicant_id='"+aid+"'";
...
<h1 align="center" style=" color: #1C98B2; font-family: Georgia;">PERSONAL DETAILS</h1>
